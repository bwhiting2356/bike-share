import { Component, ElementRef, EventEmitter, Input, Optional, Output, Renderer, ViewChild, ViewEncapsulation,
...
@Component({
  ...
  '<input #searchbarInput id="searchbar" class="searchbar-input" (input)="inputChanged($event)" (blur)="inputBlurred()" (focus)="inputFocused()" ' +
  'dir="auto" ' +
...
export class SearchbarComponent extends BaseInput<string> implements AfterViewInit {
